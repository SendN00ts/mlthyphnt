  ...
  return (
    <div className="overflow-x-hidden w-full">
      ...
      <main className="relative h-auto bg-[#9b948f] text-[#174714] flex flex-col">
        ...
        <section className="w-full flex items-center py-8 px-6 mb-4" style={{ minHeight: "220px" }}>
          <div className="max-w-5xl mx-auto w-full">
            {/* Title and GIF container - More offset to the left, especially on mobile */}
            <div className="flex flex-row items-center gap-4 sm:gap-6 md:gap-8 justify-start ml-[-20px] sm:ml-[-60px] md:ml-[-90px] lg:ml-[-110px]">
